...
describe('VideoSourceNamer', function() {
  ...
  function forTitle(s) {
    const videoSource = new VideoSource(undefined, {url: 'http://dummy/'});
  ...
  function forSite(domain, title) {
    ...
    const videoSource = new VideoSource(undefined, {url});
  ...
  describe('#titleStripStartPart', function() {
    ...
    it('should strip given string at start of title', function() {
      // Standard stripping
      const namer = forTitle(' some value - anything else - some value');
  ...
  describe('#titleStripDomain', function() {
    ...
    it('should strip domain at start or end of title', function() {
      const namer = forSite('some.mydomain.tld', ' mydomain - mydomain.tld | some.mydomain.tld # test # some.mydomain.tld | mydomain.tld - mydomain ');
  ...
  describe('#titleStripRegexp', function() {
    ...
    it('should strip regexp matching title', function() {
      const namer = forTitle(' value1 optional1 value2 value3 value4 value5 value6 ');
